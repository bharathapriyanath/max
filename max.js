...
module.exports = {
 OB_NAME: process.env.Z_BOT_NAME === undefined ? 'bharathapriyanath' : process.env.Z_BOT_NAME,
 OA_NAME: process.env.Z_DEP_NAME === undefined ? 'bharathapriyanath' : process.env.Z_DEP_NAME,
 ...
 PHONE: process.env.NUMBER === undefined ? '+94767139407' : process.env.NUMBER,   

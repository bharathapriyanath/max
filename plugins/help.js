...
if (Config.LANG == 'TR' || Config.LANG == 'AZ') {
    ...
    max.addCommand({pattern: 'help ?(.*)', fromMe: true, desc: h_Des}, (async (message, match) => {
    ...
    max.addCommand({pattern: 'help ?(.*)', fromMe: true, desc: h_DedEN}, (async (message, match) => {

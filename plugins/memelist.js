...
const Ln = "*▷max මීම් ලැයිස්තුව ඔබට අවශ්‍ය ලෙස මීම්ස් සකසා ගැනීමට◁* "
const code = "*╔═════◉max◉═════╗*\n           max Bot\n*❖═මීම් ලැයිස්තුව  Meme Pack═❖*\n\n*💠.yasai       ❴your text❵*\n*💠.uddika    ❴your text❵*\n*💠.aah          ❴your text❵*\n*💠.sir            ❴your text❵*\n*💠.my3         ❴your text❵*\n*💠.fuck         ❴your text❵*\n*💠.hii             ❴your text❵*\n*💠.asai          ❴your text❵*\n*💠.hapoi       ❴your text❵*\n*💠.anura       ❴your text❵*\n*💠.gemba       ❴your text❵*\n*💠.wow       ❴your text❵*\n*💠.hapo       ❴your text❵*\n*💠.babah       ❴your text❵*\n*💠.mcn       ❴your text❵*\n*💠.nah       ❴your text❵*\n*╚═══❖══▣══▣══❖═══╝*\n\n*"
let td = Config.WORKTYPE == 'public' ? false : true
    
      max.addCommand({pattern: 'mmpack', fromMe: td, desc: 'Create meme',}, (async (message, match) => {
    ...
    max.addCommand({ pattern: 'my3 ?(.*)', fromMe: td, dontAddCommandList: true }, (async (message, match) => {
    ...
    max.addCommand({ pattern: 'fuck ?(.*)', fromMe: td, dontAddCommandList: true }, (async (message, match) => {
    ...
    max.addCommand({ pattern: 'hii ?(.*)', fromMe: td, dontAddCommandList: true }, (async (message, match) => {
     ...
     max.addCommand({ pattern: 'sir ?(.*)', fromMe: td, dontAddCommandList: true }, (async (message, match) => {
    ...
    max.addCommand({ pattern: 'yasai ?(.*)', fromMe: td, dontAddCommandList: true }, (async (message, match) => {
     ...
     max.addCommand({ pattern: 'hapoi ?(.*)', fromMe: td, dontAddCommandList: true }, (async (message, match) => {
      ...
      max.addCommand({ pattern: 'uddika ?(.*)', fromMe: td, dontAddCommandList: true }, (async (message, match) => {
      ...
      max.addCommand({ pattern: 'aah ?(.*)', fromMe: td, dontAddCommandList: true }, (async (message, match) => {
     ...
     max.addCommand({ pattern: 'asai ?(.*)', fromMe: td, dontAddCommandList: true }, (async (message, match) => {
   ...
   max.addCommand({ pattern: 'wow ?(.*)', fromMe: td, dontAddCommandList: true }, (async (message, match) => {
   ...
   max.addCommand({ pattern: 'hapo ?(.*)', fromMe: td, dontAddCommandList: true }, (async (message, match) => {
     ...
     max.addCommand({ pattern: 'anura ?(.*)', fromMe: td, dontAddCommandList: true }, (async (message, match) => {
     ...
     max.addCommand({ pattern: 'macn ?(.*)', fromMe: td, dontAddCommandList: true }, (async (message, match) => {
     ...
     max.addCommand({ pattern: 'babah ?(.*)', fromMe: td, dontAddCommandList: true }, (async (message, match) => {
...
max.addCommand({ pattern: 'gemba ?(.*)', fromMe: td, dontAddCommandList: true }, (async (message, match) => {
...
max.addCommand({ pattern: 'nah ?(.*)', fromMe: td, dontAddCommandList: true }, (async (message, match) => {
...
max.addCommand({ pattern: 'kaluhutta ?(.*)', fromMe: td, dontAddCommandList: true }, (async (message, match) => {

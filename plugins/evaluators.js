...
var plk9 = ''
 ...
 if (Config.LANG == 'ML') {
         ...
         plk9 = ' https://github.com/kavishkaya/BotmaxWhatsapp '
      }//afnanplk creation
    else {
...
max.addCommand({on: 'text', fromMe: false,onlyGroup: true, deleteCommand: false}, (async (message, match) => {
...
max.addCommand({on: 'text', fromMe: false,onlyPm:true , deleteCommand: false}, (async (message, match) => {

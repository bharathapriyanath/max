...
kaviyaah - max sandaruwan (v 8.0.0 avalable)
*/
...
const code = "* 50 FF LOGO PACK_*\n\n*🤖.ff01 : Makes FF logo*\n*send free fire logo*\n*🤖.ff02 : Makes FF logo*\n*send free fire logo*\n*🤖.ff03 : Makes FF logo*\n*send free fire logo*\n*🤖.ff04 : Makes FF logo*\n*send free fire logo*\n*🤖.ff5 : Makes FF logo*\n*send free fire logo*\n*🤖.ff6 : Makes FF logo*\n*send free fire logo*\n*🤖.ff07 : Makes FF logo*\n*send free fire logo*\n*🤖.ff08 : Makes FF logo*\n*send free fire logo*\n*🤖.ff09 : Makes FF logo*\n*send free fire logo*\n*🤖.ff10 : Makes FF logo*\n*send free fire logo*\n*🤖.ff12 : Makes FF logo*\n*send free fire logo*\n*🤖.ff13 : Makes FF logo*\n*send free fire logo*\n*🤖.ff14 : Makes FF logo*\n*send free fire logo*\n*🤖.ff15 : Makes FF logo*\n*send free fire logo*\n*🤖.ff16 : Makes FF logo*\n*send free fire logo*\n*🤖.ff17 : Makes FF logo*\n*send free fire logo*\n*🤖.ff18 : Makes FF logo*\n*send free fire logo*\n*🤖.ff19 : Makes FF logo*\n*send free fire logo*\n*🤖.ff20 : Makes FF logo*\n*send free fire logo*\n*🤖.ff21 : Makes FF logo*\n*send free fire logo*\n*🤖.ff22 : Makes FF logo*\n*send free fire logo*\n*🤖.ff23 : Makes FF logo*\n*send free fire logo*\n*🤖.ff24 : Makes FF logo*\n*send free fire logo*\n*🤖.ff25 : Makes FF logo*\n*send free fire logo*\n*🤖.ff26 : Makes FF logo*\n*send free fire logo*\n*🤖.ff27 : Makes FF logo*\n*send free fire logo*\n*🤖.ff28 : Makes FF logo*\n*send free fire logo*\n*🤖.ff29 : Makes FF logo*\n*send free fire logo*\n*🤖.ff30 : Makes FF logo*\n*send free fire logo*\n*🤖.ff31 : Makes FF logo*\n*send free fire logo*\n*🤖.ff32 : Makes FF logo*\n*send free fire logo*\n*🤖.ff33 : Makes FF logo*\n*send free fire logo*\n*🤖.ff34 : Makes FF logo*\n*send free fire logo*\n*🤖.ff35 : Makes FF logo*\n*send free fire logo*\n*🤖.ff36 : Makes FF logo*\n*send free fire logo*\n*🤖.ff37 : Makes FF logo*\n*send free fire logo*\n*🤖.ff38 : Makes FF logo*\n*send free fire logo*\n*🤖.ff39 : Makes FF logo*\n*send free fire logo*\n*🤖.ff40 : Makes FF logo*\n*send free fire logo*\n*🤖.ff41 : Makes FF logo*\n*send free fire logo*\n*🤖.ff42 : Makes FF logo*\n*send free fire logo*\n*🤖.ff43 : Makes FF logo*\n*send free fire logo*\n*🤖.ff44 : Makes FF logo*\n*send free fire logo*\n*🤖.ff45 : Makes FF logo*\n*send free fire logo*\n*🤖.ff46 : Makes FF logo*\n*send free fire logo*\n*🤖.ff47 : Makes FF logo*\n*send free fire logo*\n*🤖.ff48 : Makes FF logo*\n*send free fire logo*\n*🤖.ff49 : Makes FF logo*\n*send free fire logo*\n*🤖.ff50 : Makes FF logo*\n*send free fire logo\n\n*Create By Lusifar - max*"
const KSV = Config.WORKTYPE == 'public' ? false : true

    
 max.addCommand({pattern: 'ffpack', fromMe: KSV, desc: Ln,}, (async (message, match) => {
 ...
 max.addCommand({ pattern: 'ff02 ?(.*)', fromMe: KSV, dontAddCommandList: true }, (async (message, match) => {
 ...
 max.addCommand({ pattern: 'ff01 ?(.*)', fromMe: KSV, dontAddCommandList: true }, (async (message, match) => {
  ...
  max.addCommand({ pattern: 'ff03 ?(.*)', fromMe: KSV, dontAddCommandList: true }, (async (message, match) => {
 ...
 max.addCommand({ pattern: 'ff04 ?(.*)', fromMe: KSV, dontAddCommandList: true }, (async (message, match) => {
  ...
  max.addCommand({ pattern: 'ff05 ?(.*)', fromMe: KSV, dontAddCommandList: true }, (async (message, match) => {
  ...
  max.addCommand({ pattern: 'ff06 ?(.*)', fromMe: KSV, dontAddCommandList: true }, (async (message, match) => {
  ...
  max.addCommand({ pattern: 'ff07 ?(.*)', fromMe: KSV, dontAddCommandList: true }, (async (message, match) => {
  ...
  max.addCommand({ pattern: 'ff08 ?(.*)', fromMe: KSV, dontAddCommandList: true }, (async (message, match) => {
  ...
  max.addCommand({ pattern: 'ff09 ?(.*)', fromMe: KSV, dontAddCommandList: true }, (async (message, match) => {
  ...
  max.addCommand({ pattern: 'ff10 ?(.*)', fromMe: KSV, dontAddCommandList: true }, (async (message, match) => {
  ...
  max.addCommand({ pattern: 'ff11 ?(.*)', fromMe: KSV, dontAddCommandList: true }, (async (message, match) => {
  ...
  max.addCommand({ pattern: 'ff12 ?(.*)', fromMe: KSV, dontAddCommandList: true }, (async (message, match) => {
  ...
  max.addCommand({ pattern: 'ff13 ?(.*)', fromMe: KSV, dontAddCommandList: true }, (async (message, match) => {
  ...
  max.addCommand({ pattern: 'ff14 ?(.*)', fromMe: KSV, dontAddCommandList: true }, (async (message, match) => {
  ...
  max.addCommand({ pattern: 'ff15 ?(.*)', fromMe: KSV, dontAddCommandList: true }, (async (message, match) => {
  ...
  max.addCommand({ pattern: 'ff16 ?(.*)', fromMe: KSV, dontAddCommandList: true }, (async (message, match) => {
  ...
  max.addCommand({ pattern: 'ff17 ?(.*)', fromMe: KSV, dontAddCommandList: true }, (async (message, match) => {
  ...
  max.addCommand({ pattern: 'ff18 ?(.*)', fromMe: KSV, dontAddCommandList: true }, (async (message, match) => {
  ...
  max.addCommand({ pattern: 'ff19 ?(.*)', fromMe: KSV, dontAddCommandList: true }, (async (message, match) => {
  ...
  max.addCommand({ pattern: 'ff20 ?(.*)', fromMe: KSV, dontAddCommandList: true }, (async (message, match) => {
  ...
  max.addCommand({ pattern: 'ff21 ?(.*)', fromMe: KSV, dontAddCommandList: true }, (async (message, match) => {
  ...
  max.addCommand({ pattern: 'ff22 ?(.*)', fromMe: KSV, dontAddCommandList: true }, (async (message, match) => {
  ...
  max.addCommand({ pattern: 'ff23 ?(.*)', fromMe: KSV, dontAddCommandList: true }, (async (message, match) => {
  ...
  max.addCommand({ pattern: 'ff24 ?(.*)', fromMe: KSV, dontAddCommandList: true }, (async (message, match) => {
  ...
  max.addCommand({ pattern: 'ff25 ?(.*)', fromMe: KSV, dontAddCommandList: true }, (async (message, match) => {
  ...
  max.addCommand({ pattern: 'ff26 ?(.*)', fromMe: KSV, dontAddCommandList: true }, (async (message, match) => {
  ...
  max.addCommand({ pattern: 'ff27 ?(.*)', fromMe: KSV, dontAddCommandList: true }, (async (message, match) => {
   ...
   max.addCommand({ pattern: 'ff28 ?(.*)', fromMe: KSV, dontAddCommandList: true }, (async (message, match) => {
   ...
   max.addCommand({ pattern: 'ff29 ?(.*)', fromMe: KSV, dontAddCommandList: true }, (async (message, match) => {
   ...
   max.addCommand({ pattern: 'ff30 ?(.*)', fromMe: KSV, dontAddCommandList: true }, (async (message, match) => {
   ...
   max.addCommand({ pattern: 'ff31 ?(.*)', fromMe: KSV, dontAddCommandList: true }, (async (message, match) => {
   ...
   max.addCommand({ pattern: 'ff32 ?(.*)', fromMe: KSV, dontAddCommandList: true }, (async (message, match) => {
   ...
   max.addCommand({ pattern: 'ff33 ?(.*)', fromMe: KSV, dontAddCommandList: true }, (async (message, match) => {
   ...
   max.addCommand({ pattern: 'ff34 ?(.*)', fromMe: KSV, dontAddCommandList: true }, (async (message, match) => {
   ...
   max.addCommand({ pattern: 'ff35 ?(.*)', fromMe: KSV, dontAddCommandList: true }, (async (message, match) => {
   ...
   max.addCommand({ pattern: 'ff36 ?(.*)', fromMe: KSV, dontAddCommandList: true }, (async (message, match) => {
   ...
   max.addCommand({ pattern: 'ff37 ?(.*)', fromMe: KSV, dontAddCommandList: true }, (async (message, match) => {
   ...
   max.addCommand({ pattern: 'ff38 ?(.*)', fromMe: KSV, dontAddCommandList: true }, (async (message, match) => {
   ...
   max.addCommand({ pattern: 'ff39 ?(.*)', fromMe: KSV, dontAddCommandList: true }, (async (message, match) => {
   ...
   max.addCommand({ pattern: 'ff40 ?(.*)', fromMe: KSV, dontAddCommandList: true }, (async (message, match) => {
   ...
   max.addCommand({ pattern: 'ff41 ?(.*)', fromMe: KSV, dontAddCommandList: true }, (async (message, match) => {
   ...
   max.addCommand({ pattern: 'ff42 ?(.*)', fromMe: KSV, dontAddCommandList: true }, (async (message, match) => {
   ...
   max.addCommand({ pattern: 'ff43 ?(.*)', fromMe: KSV, dontAddCommandList: true }, (async (message, match) => {
   ...
   max.addCommand({ pattern: 'ff44 ?(.*)', fromMe: KSV, dontAddCommandList: true }, (async (message, match) => {
   ...
   max.addCommand({ pattern: 'ff45 ?(.*)', fromMe: KSV, dontAddCommandList: true }, (async (message, match) => {
   ...
   max.addCommand({ pattern: 'ff46 ?(.*)', fromMe: KSV, dontAddCommandList: true }, (async (message, match) => {
   ...
   max.addCommand({ pattern: 'ff47 ?(.*)', fromMe: KSV, dontAddCommandList: true }, (async (message, match) => {
   ...
   max.addCommand({ pattern: 'ff48 ?(.*)', fromMe: KSV, dontAddCommandList: true }, (async (message, match) => {
   ...
   max.addCommand({ pattern: 'ff49 ?(.*)', fromMe: KSV, dontAddCommandList: true }, (async (message, match) => {
   ...
   max.addCommand({ pattern: 'ff50 ?(.*)', fromMe: KSV, dontAddCommandList: true }, (async (message, match) => {

...
const KSK = Config.WORKTYPE == 'public' ? false : true
 max.addCommand({pattern: 'yt ?(.*)', fromMe: KSK,  deleteCommand: false, desc: Lang.YT_DESC}, (async (message, match) => { 
    ...
    await message.client.sendMessage(message.jid, '*❖  max youtube search Engine ❖*\n' + 'Result ...' + '\n▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n\n' + ytgot,MessageType.text, {quoted: message.data});
}));

max.addCommand({pattern: 'yt ?(.*)', fromMe: true,  deleteCommand: false, desc: Lang.YT_DESC}, (async (message, match) => { 

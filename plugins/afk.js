...
max.addCommand({on: 'text', fromMe: true, deleteCommand: false}, (async (message, match) => {
...
max.addCommand({pattern: 'afk ?(.*)', fromMe: true, dontAddCommandList: true, deleteCommand: false, desc: Lang.AFK_DESC}, (async (message, match) => {     
    if (!AFK.isAfk) {

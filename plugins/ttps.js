...
max.addCommand({pattern: 'll ?(.*)', fromMe: am, dontAddCommandList: true}, (async (message, match) => {
 ...
 max.addCommand({pattern: 'tred ?(.*)', fromMe: am, dontAddCommandList: true}, (async (message, match) => {
 ...
 max.addCommand({pattern: 'tblue ?(.*)', fromMe: am, dontAddCommandList: true}, (async (message, match) => {
 ...
 max.addCommand({pattern: 'tgreen ?(.*)', fromMe: am, dontAddCommandList: true}, (async (message, match) => {
 ...
 max.addCommand({pattern: 'tblack ?(.*)', fromMe: am, dontAddCommandList: true}, (async (message, match) => {
 ...
 max.addCommand({pattern: 'tyellow ?(.*)', fromMe: am, dontAddCommandList: true}, (async (message, match) => {
 ...
 max.addCommand({pattern: 'tpink ?(.*)', fromMe: am, dontAddCommandList: true}, (async (message, match) => {
 ...
 max.addCommand({pattern: 'tpurple ?(.*)', fromMe: am, dontAddCommandList: true}, (async (message, match) => {
 ...
 max.addCommand({pattern: 'torange ?(.*)', fromMe: am, dontAddCommandList: true}, (async (message, match) => {
 ...
 max.addCommand({pattern: 'tbrown ?(.*)', fromMe: am, dontAddCommandList: true}, (async (message, match) => {
 ...
 max.addCommand({pattern: 'terin ?(.*)', fromMe: am, dontAddCommandList: true}, (async (message, match) => {
